    ...
    fun main(args: Array<String>) 
    {
        class Person{   // Класс Person
            var name: String = "Ablaev Artur"   // Объявляем свойства
        ...
        a.name = "Odobashi Sali"  // Изменяем свойство переменной
    ...
    {
        class Person{   // Класс Person
            var _name : String = "n" //создается 2 значения к классу  Person _n,n
            var name: String = "nn"
                get(){
        ...
        val a = Person()
        println(a.name)
        a.name = "fefe"//  после данной строки срабатывает set
        println(a.name)
