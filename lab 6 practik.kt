...
open class Building     //класс постройки
{
    ...
    public fun Building(length: Int, Width: Int, LotLength: Int, LotWidth: Int) //метод инициализацие постройки
    {
    ...
    public fun getLength() :Int { return  mLength}      //метод возвращающий длину постройки
    public fun getWidth() :Int { return  mWidth}        //метод возвращающий ширину постройки 
    public fun getLotLength() :Int { return  mLotLength}    //метод возвращающий длину участка
    public fun getLotWidth() :Int { return  mLotWidth}  //метод возвращающий ширину участка
    public fun setLength(value: Int) { mLength = value}     //метод задающий длину постройки
    public fun setWidth(value: Int) { mWidth = value}       //метод задающий ширину постройки
    public fun setLotLength(value: Int) { mLotLength = value}       //метод задающий длину участка
    public fun setLotWidth(value: Int) { mLotWidth = value}     //метод задающий ширину участка
    public fun calcBuildingArea() :Int { return  mLength * mWidth}  //метод считающий площадь постройки
    public fun calcLotArea() :Int { return  mLotLength * mLotWidth} //метод считающий площадь участка
...
open class House : Building()   //класс дом наследуется от постройки
{
    ...
    public fun getOwner() :String { return  mOwner}     //метод возвращающий владельца
    public fun hasPool() :Boolean { return mPool }      //метод возвращающий флаг наличия бассейна
    public fun setOwner(value: String) { mOwner = value }   //метод задающий владельца
    public fun setPool(value: Boolean) { mPool = value }    //метод задающий флаг наличия бассейна
    public override fun toString() :String  //замена стандартной функции toString()
    {
        var s :String = ""
        s += "Owner: "
    ...
    public  fun equals(value: House) :Boolean   //метод сравнения двух похожих домов по признакам
    {
...
class Cottage : House()         //класс котедж унаследован от дома
{
    ...
    public fun hasSecondFloor() :Boolean { return mSecondFlor }     //метод возвращающий наличие второго этажа
    public override fun toString() :String  //замена стандартной функции toString()
    {
        var s :String = super.toString()    // обращаемся через super к родителю и вызываем метод toString()
...
class Office : Building()   //класс офиис
{
    ...
    public fun getBusinessName() :String { return  mBusinessName}       //метод возвращающий имя бизнеса
    public fun getParkingSpaces() :Int { return  mParkingSpaces}    //метод возвращающий количество парковачных мест
    public fun setBusinessName(value: String) { mBusinessName = value}  //метод задающий имя бизнеса
    public fun setParkingSpaces(value: Int) { mParkingSpaces = value}   //метод задающий количество парковочных мест
    public override fun toString() :String  //замена стандартной функции toString()
    {
        var s :String = ""
        s += "Business: "
    ...
    public  fun equals(value: Office) :Boolean  //метод сравнения двух похожих офиссов по признакам
    {
