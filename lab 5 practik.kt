...
    abstract fun area(): Float
  ...
  //объявляем производный класс triangle
  class triangle(val height: Float, val a:Float,val b:Float,val c:Float):Figure(){
  ...
  //объявляем производный класс trapeze
  class trapeze(val height: Float, val a:Float,val b:Float,val c:Float,val d:Float):Figure(){
    //переопределённый метод perimeter
    override fun perimeter(): Float{
        return a+b+c+d
    }
